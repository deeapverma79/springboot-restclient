...
/**
 * Main controller class which receives the request from form.html.
 * This provides a GET & POST API.
 */
...
public class WeatherServiceController {
	...
	/**
	 * Get is used to display the main page form.html which is a thymeleaf template.
	 * @param model
	 * @return
	 */
	 ...
	 * The method acts as a client and uses RestTemplate to retrieve the weather data from openweathermap.org
	 * @param model
